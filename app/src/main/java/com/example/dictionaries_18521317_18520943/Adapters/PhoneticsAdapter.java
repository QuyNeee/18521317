...
import com.example.dictionaries_18521317_18520943.Models.Phonetics;
import com.example.dictionaries_18521317_18520943.OnFetchDataListener;
import com.example.dictionaries_18521317_18520943.R;
import com.example.dictionaries_18521317_18520943.ViewHolders.PhoneticViewHolder;
...
public class PhoneticsAdapter extends RecyclerView.Adapter<PhoneticViewHolder> {
    ...
    public PhoneticsAdapter(OnFetchDataListener context, List<Phonetics> phoneticsList) {
    ...
    public PhoneticViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PhoneticViewHolder(LayoutInflater.from((Context) context).inflate(R.layout.phonetic_list_item, parent, false));
    }
        ...
        holder.imageButton_audio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText((Context) context, "Couldn't play audio!", Toast.LENGTH_SHORT).show();

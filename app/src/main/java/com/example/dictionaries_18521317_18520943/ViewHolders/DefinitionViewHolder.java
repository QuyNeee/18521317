...
public class DefinitionViewHolder extends RecyclerView.ViewHolder {
    public TextView textView_definition, textView_example, textView_synonyms, textView_antonynyms;
    public DefinitionViewHolder(@NonNull View itemView) {
        ...
        textView_antonynyms = itemView.findViewById(R.id.textView_Antonyms);
